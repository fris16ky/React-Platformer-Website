function unityFramework(Module) {
  ...
  function _JS_DOM_MapViewportCoordinateToElementLocalCoordinate(
    ...
    if (canvas) {
      ...
      // Handle the situation when the canvas element is not available
      // You can set default values or perform alternative logic here
    }
  }
  ...
  var asmLibraryArg = {
    Wd: _JS_Accelerometer_IsRunning,
    hb: _JS_Accelerometer_Start,
    gb: _JS_Accelerometer_Stop,
    ...
    Ud: _JS_GravitySensor_IsRunning,
    db: _JS_GravitySensor_Start,
    cb: _JS_GravitySensor_Stop,
    Td: _JS_Gyroscope_IsRunning,
    bb: _JS_Gyroscope_Start,
    ab: _JS_Gyroscope_Stop,
    Vd: _JS_LinearAccelerationSensor_IsRunning,
    fb: _JS_LinearAccelerationSensor_Start,
    eb: _JS_LinearAccelerationSensor_Stop,
    cc: _JS_Log_Dump,
    Gd: _JS_Log_StackTrace,
    Xd: _JS_OrientationSensor_IsRunning,
    jb: _JS_OrientationSensor_Start,
    ib: _JS_OrientationSensor_Stop,
    nb: _JS_RequestDeviceSensorPermissionsOnTouch,
    Ad: _JS_RunQuitCallbacks,
    Rd: _JS_ScreenOrientation_DeInit,
    Yd: _JS_ScreenOrientation_Init,
    T: _JS_ScreenOrientation_Lock,
    pe: _JS_Sound_Create_Channel,
    Eb: _JS_Sound_GetLength,
    le: _JS_Sound_GetLoadState,
    je: _JS_Sound_Init,
    Bb: _JS_Sound_Load,
    ke: _JS_Sound_Load_PCM,
    xa: _JS_Sound_Play,
    ya: _JS_Sound_ReleaseInstance,
    ob: _JS_Sound_ResumeIfNeeded,
    me: _JS_Sound_Set3D,
    he: _JS_Sound_SetListenerOrientation,
    ie: _JS_Sound_SetListenerPosition,
    Db: _JS_Sound_SetLoop,
    Cb: _JS_Sound_SetLoopPoints,
    ea: _JS_Sound_SetPaused,
    V: _JS_Sound_SetPitch,
    oe: _JS_Sound_SetPosition,
    ne: _JS_Sound_SetVolume,
    fa: _JS_Sound_Stop,
    Z: _JS_SystemInfo_GetCanvasClientSize,
    Ab: _JS_SystemInfo_GetDocumentURL,
    Ua: _JS_SystemInfo_GetGPUInfo,
    $a: _JS_SystemInfo_GetMatchWebGLToCanvasSize,
    Va: _JS_SystemInfo_GetMemory,
    Wa: _JS_SystemInfo_GetOS,
    Ya: _JS_SystemInfo_GetPreferredDevicePixelRatio,
    Id: _JS_SystemInfo_GetScreenSize,
    _d: _JS_SystemInfo_HasAstcHdr,
    Xa: _JS_SystemInfo_HasCursorLock,
    Qd: _JS_SystemInfo_HasFullscreen,
    ...
    Od: _emscripten_exit_fullscreen,
    Jd: _emscripten_exit_pointerlock,
    Hd: _emscripten_get_canvas_element_size,
    Nd: _emscripten_get_fullscreen_status,
    kb: _emscripten_get_gamepad_status,
    Fc: _emscripten_get_heap_max,
    D: _emscripten_get_now,
    lb: _emscripten_get_num_gamepads,
    Cd: _emscripten_html5_remove_all_event_listeners,
    be: _emscripten_is_webgl_context_lost,
    y: _emscripten_log,
    C: _emscripten_longjmp,
    Bg: _emscripten_memcpy_big,
    Pd: _emscripten_request_fullscreen,
    Kd: _emscripten_request_pointerlock,
    Cg: _emscripten_resize_heap,
    mb: _emscripten_sample_gamepad_data,
    Za: _emscripten_set_blur_callback_on_thread,
    sa: _emscripten_set_canvas_element_size,
    Ld: _emscripten_set_focus_callback_on_thread,
    Md: _emscripten_set_fullscreenchange_callback_on_thread,
    qb: _emscripten_set_gamepadconnected_callback_on_thread,
    pb: _emscripten_set_gamepaddisconnected_callback_on_thread,
    ...
    yb: _emscripten_set_mouseup_callback_on_thread,
    rb: _emscripten_set_touchcancel_callback_on_thread,
    tb: _emscripten_set_touchend_callback_on_thread,
    sb: _emscripten_set_touchmove_callback_on_thread,
    ub: _emscripten_set_touchstart_callback_on_thread,
    vb: _emscripten_set_wheel_callback_on_thread,
    ...
    ee: _emscripten_webgl_init_context_attributes,
    ca: _emscripten_webgl_make_context_current,
    kf: _environ_get,
    uf: _environ_sizes_get,
    w: _exit,
    N: _fd_close,
    Sc: _fd_fdstat_get,
    Ra: _fd_read,
    ...
    rg: _glAttachShader,
    Kb: _glBeginQuery,
    ef: _glBeginTransformFeedback,
    oa: _glBindAttribLocation,
    qg: _glBindBuffer,
    Ge: _glBindBufferBase,
    Fe: _glBindBufferRange,
    ng: _glBindFramebuffer,
    og: _glBindRenderbuffer,
    Ae: _glBindSampler,
    pg: _glBindTexture,
    Ze: _glBindTransformFeedback,
    af: _glBindVertexArray,
    $b: _glBlendEquation,
    ac: _glBlendEquationSeparate,
    bc: _glBlendFuncSeparate,
    Re: _glBlitFramebuffer,
    lg: _glBufferData,
    mg: _glBufferSubData,
    kg: _glCheckFramebufferStatus,
    gg: _glClear,
    we: _glClearBufferfi,
    ve: _glClearBufferfv,
    ...
    ig: _glClearDepthf,
    jg: _glClearStencil,
    Lc: _glClientWaitSync,
    Ja: _glColorMask,
    fg: _glCompileShader,
    dg: _glCompressedTexImage2D,
    Te: _glCompressedTexImage3D,
    eg: _glCompressedTexSubImage2D,
    Xe: _glCompressedTexSubImage3D,
    Je: _glCopyBufferSubData,
    cg: _glCopyTexImage2D,
    _b: _glCopyTexSubImage2D,
    bg: _glCreateProgram,
    ag: _glCreateShader,
    $f: _glCullFace,
    _f: _glDeleteBuffers,
    Zf: _glDeleteFramebuffers,
    Yf: _glDeleteProgram,
    Da: _glDeleteQueries,
    Xf: _glDeleteRenderbuffers,
    ze: _glDeleteSamplers,
    Wf: _glDeleteShader,
    Gb: _glDeleteSync,
    Vf: _glDeleteTextures,
    _e: _glDeleteTransformFeedbacks,
    cf: _glDeleteVertexArrays,
    na: _glDepthFunc,
    ma: _glDepthMask,
    Uf: _glDetachShader,
    Tf: _glDisable,
    Sf: _glDisableVertexAttribArray,
    Pf: _glDrawArrays,
    Le: _glDrawArraysInstanced,
    Ie: _glDrawBuffers,
    Qf: _glDrawElements,
    Ke: _glDrawElementsInstanced,
    Rf: _glEnable,
    Of: _glEnableVertexAttribArray,
    Lb: _glEndQuery,
    ff: _glEndTransformFeedback,
    Fb: _glFenceSync,
    Lf: _glFinish,
    Mf: _glFlush,
    ...
    la: _glFrontFace,
    Kf: _glGenBuffers,
    Gf: _glGenFramebuffers,
    Jb: _glGenQueries,
    Hf: _glGenRenderbuffers,
    ye: _glGenSamplers,
    Jf: _glGenTextures,
    $e: _glGenTransformFeedbacks,
    df: _glGenVertexArrays,
    If: _glGenerateMipmap,
    Ag: _glGetActiveAttrib,
    Ia: _glGetActiveUniform,
    Aa: _glGetActiveUniformBlockName,
    Q: _glGetActiveUniformBlockiv,
    P: _glGetActiveUniformsiv,
    zg: _glGetAttribLocation,
    $d: _glGetBufferSubData,
    Ff: _glGetError,
    Ef: _glGetFramebufferAttachmentParameteriv,
    tg: _glGetIntegeri_v,
    pa: _glGetIntegerv,
    Ce: _glGetInternalformativ,
    Hb: _glGetProgramBinary,
    wg: _glGetProgramInfoLog,
    K: _glGetProgramiv,
    hf: _glGetQueryObjectuiv,
    gf: _glGetQueryiv,
    Nf: _glGetRenderbufferParameteriv,
    Cf: _glGetShaderInfoLog,
    Zb: _glGetShaderPrecisionFormat,
    Df: _glGetShaderSource,
    vg: _glGetShaderiv,
    Bf: _glGetString,
    Pe: _glGetStringi,
    Af: _glGetTexParameteriv,
    De: _glGetUniformBlockIndex,
    za: _glGetUniformIndices,
    W: _glGetUniformLocation,
    Yb: _glGetUniformiv,
    yg: _glGetVertexAttribiv,
    ...
    He: _glReadBuffer,
    S: _glReadPixels,
    xf: _glRenderbufferStorage,
    Qe: _glRenderbufferStorageMultisample,
    Be: _glSamplerParameteri,
    Ha: _glScissor,
    vf: _glShaderSource,
    wf: _glStencilFuncSeparate,
    sf: _glStencilMask,
    ...
    of: _glTexSubImage2D,
    We: _glTexSubImage3D,
    Ye: _glTransformFeedbackVaryings,
    Mb: _glUniform1fv,
    ja: _glUniform1i,
    Nb: _glUniform1iv,
    Ob: _glUniform1uiv,
    ...
    Ne: _glUnmapBuffer,
    jf: _glUseProgram,
    xg: _glValidateProgram,
    lf: _glVertexAttrib4f,
    mf: _glVertexAttrib4fv,
    Ee: _glVertexAttribIPointer,
    ...
    nc: invoke_viiiiiiiiii,
    dd: invoke_viiij,
    jd: invoke_viiiji,
    _c: invoke_viij,
    cd: invoke_viiji,
    Wc: invoke_viijiiiiii,
    Nc: invoke_viji,
    kd: invoke_vijii,
    Zc: invoke_vijiii,
    ed: invoke_vji,
  ...
  var _SendMessage = (Module["_SendMessage"] = function () {
    return (_SendMessage = Module["_SendMessage"] = Module["asm"]["Hg"]).apply(
      null,
      arguments
    );
  });
  ...
  var _main = (Module["_main"] = function () {
    return (_main = Module["_main"] = Module["asm"]["Jg"]).apply(
      null,
      arguments
    );
  });
  ...
  var _htons = (Module["_htons"] = function () {
    return (_htons = Module["_htons"] = Module["asm"]["Lg"]).apply(
      null,
      arguments
    );
  });
  var _ntohs = (Module["_ntohs"] = function () {
    return (_ntohs = Module["_ntohs"] = Module["asm"]["Mg"]).apply(
      null,
      arguments
    );
  });
  var __get_tzname = (Module["__get_tzname"] = function () {
    return (__get_tzname = Module["__get_tzname"] = Module["asm"]["Ng"]).apply(
      null,
      arguments
    );
  });
  ...
  var stackSave = (Module["stackSave"] = function () {
    return (stackSave = Module["stackSave"] = Module["asm"]["Qg"]).apply(
      null,
      arguments
    );
  });
  var stackRestore = (Module["stackRestore"] = function () {
    return (stackRestore = Module["stackRestore"] = Module["asm"]["Rg"]).apply(
      null,
      arguments
    );
  });
  var stackAlloc = (Module["stackAlloc"] = function () {
    return (stackAlloc = Module["stackAlloc"] = Module["asm"]["Sg"]).apply(
      null,
      arguments
    );
  });
  var _setThrew = (Module["_setThrew"] = function () {
    return (_setThrew = Module["_setThrew"] = Module["asm"]["Tg"]).apply(
      null,
      arguments
    );
  });
  ...
  var _malloc = (Module["_malloc"] = function () {
    return (_malloc = Module["_malloc"] = Module["asm"]["Wg"]).apply(
      null,
      arguments
    );
  });
  var _free = (Module["_free"] = function () {
    return (_free = Module["_free"] = Module["asm"]["Xg"]).apply(
      null,
      arguments
    );
  });
  var _memalign = (Module["_memalign"] = function () {
    return (_memalign = Module["_memalign"] = Module["asm"]["Yg"]).apply(
      null,
      arguments
    );
  });
  var _memset = (Module["_memset"] = function () {
    return (_memset = Module["_memset"] = Module["asm"]["Zg"]).apply(
      null,
      arguments
    );
  });
  var _strlen = (Module["_strlen"] = function () {
    return (_strlen = Module["_strlen"] = Module["asm"]["_g"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viif = (Module["dynCall_viif"] = function () {
    return (dynCall_viif = Module["dynCall_viif"] = Module["asm"]["vh"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vifi = (Module["dynCall_vifi"] = function () {
    return (dynCall_vifi = Module["dynCall_vifi"] = Module["asm"]["xh"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fii = (Module["dynCall_fii"] = function () {
    return (dynCall_fii = Module["dynCall_fii"] = Module["asm"]["yh"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iji = (Module["dynCall_iji"] = function () {
    return (dynCall_iji = Module["dynCall_iji"] = Module["asm"]["Dh"]).apply(
      null,
      arguments
    );
  });
  var dynCall_jjji = (Module["dynCall_jjji"] = function () {
    return (dynCall_jjji = Module["dynCall_jjji"] = Module["asm"]["Eh"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vji = (Module["dynCall_vji"] = function () {
    return (dynCall_vji = Module["dynCall_vji"] = Module["asm"]["Ih"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fiii = (Module["dynCall_fiii"] = function () {
    return (dynCall_fiii = Module["dynCall_fiii"] = Module["asm"]["Jh"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fifi = (Module["dynCall_fifi"] = function () {
    return (dynCall_fifi = Module["dynCall_fifi"] = Module["asm"]["Kh"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fi = (Module["dynCall_fi"] = function () {
    return (dynCall_fi = Module["dynCall_fi"] = Module["asm"]["Ph"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ji = (Module["dynCall_ji"] = function () {
    return (dynCall_ji = Module["dynCall_ji"] = Module["asm"]["Vh"]).apply(
      null,
      arguments
    );
  });
  var dynCall_iifi = (Module["dynCall_iifi"] = function () {
    return (dynCall_iifi = Module["dynCall_iifi"] = Module["asm"]["Wh"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jiii = (Module["dynCall_jiii"] = function () {
    return (dynCall_jiii = Module["dynCall_jiii"] = Module["asm"]["di"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viij = (Module["dynCall_viij"] = function () {
    return (dynCall_viij = Module["dynCall_viij"] = Module["asm"]["gi"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_j = (Module["dynCall_j"] = function () {
    return (dynCall_j = Module["dynCall_j"] = Module["asm"]["mi"]).apply(
      null,
      arguments
    );
  });
  var dynCall_jijj = (Module["dynCall_jijj"] = function () {
    return (dynCall_jijj = Module["dynCall_jijj"] = Module["asm"]["ni"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_dii = (Module["dynCall_dii"] = function () {
    return (dynCall_dii = Module["dynCall_dii"] = Module["asm"]["qi"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ijji = (Module["dynCall_ijji"] = function () {
    return (dynCall_ijji = Module["dynCall_ijji"] = Module["asm"]["ri"]).apply(
      null,
      arguments
    );
  });
  var dynCall_iiji = (Module["dynCall_iiji"] = function () {
    return (dynCall_iiji = Module["dynCall_iiji"] = Module["asm"]["si"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viji = (Module["dynCall_viji"] = function () {
    return (dynCall_viji = Module["dynCall_viji"] = Module["asm"]["ui"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vffi = (Module["dynCall_vffi"] = function () {
    return (dynCall_vffi = Module["dynCall_vffi"] = Module["asm"]["Ii"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ifi = (Module["dynCall_ifi"] = function () {
    return (dynCall_ifi = Module["dynCall_ifi"] = Module["asm"]["Qi"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ffi = (Module["dynCall_ffi"] = function () {
    return (dynCall_ffi = Module["dynCall_ffi"] = Module["asm"]["Ti"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fffi = (Module["dynCall_fffi"] = function () {
    return (dynCall_fffi = Module["dynCall_fffi"] = Module["asm"]["Ui"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iffi = (Module["dynCall_iffi"] = function () {
    return (dynCall_iffi = Module["dynCall_iffi"] = Module["asm"]["Wi"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vfii = (Module["dynCall_vfii"] = function () {
    return (dynCall_vfii = Module["dynCall_vfii"] = Module["asm"]["Yi"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vfi = (Module["dynCall_vfi"] = function () {
    return (dynCall_vfi = Module["dynCall_vfi"] = Module["asm"]["_i"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ijii = (Module["dynCall_ijii"] = function () {
    return (dynCall_ijii = Module["dynCall_ijii"] = Module["asm"]["Fj"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vjii = (Module["dynCall_vjii"] = function () {
    return (dynCall_vjii = Module["dynCall_vjii"] = Module["asm"]["Gj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ffii = (Module["dynCall_ffii"] = function () {
    return (dynCall_ffii = Module["dynCall_ffii"] = Module["asm"]["jk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_idi = (Module["dynCall_idi"] = function () {
    return (dynCall_idi = Module["dynCall_idi"] = Module["asm"]["Kk"]).apply(
      null,
      arguments
    );
  });
  var dynCall_diii = (Module["dynCall_diii"] = function () {
    return (dynCall_diii = Module["dynCall_diii"] = Module["asm"]["Lk"]).apply(
      null,
      arguments
    );
  });
  var dynCall_jjii = (Module["dynCall_jjii"] = function () {
    return (dynCall_jjii = Module["dynCall_jjii"] = Module["asm"]["Mk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jji = (Module["dynCall_jji"] = function () {
    return (dynCall_jji = Module["dynCall_jji"] = Module["asm"]["Pk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jdi = (Module["dynCall_jdi"] = function () {
    return (dynCall_jdi = Module["dynCall_jdi"] = Module["asm"]["dl"]).apply(
      null,
      arguments
    );
  });
  var dynCall_jfi = (Module["dynCall_jfi"] = function () {
    return (dynCall_jfi = Module["dynCall_jfi"] = Module["asm"]["el"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fji = (Module["dynCall_fji"] = function () {
    return (dynCall_fji = Module["dynCall_fji"] = Module["asm"]["fl"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fdi = (Module["dynCall_fdi"] = function () {
    return (dynCall_fdi = Module["dynCall_fdi"] = Module["asm"]["gl"]).apply(
      null,
      arguments
    );
  });
  var dynCall_dji = (Module["dynCall_dji"] = function () {
    return (dynCall_dji = Module["dynCall_dji"] = Module["asm"]["hl"]).apply(
      null,
      arguments
    );
  });
  var dynCall_dfi = (Module["dynCall_dfi"] = function () {
    return (dynCall_dfi = Module["dynCall_dfi"] = Module["asm"]["il"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vidi = (Module["dynCall_vidi"] = function () {
    return (dynCall_vidi = Module["dynCall_vidi"] = Module["asm"]["jl"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jidi = (Module["dynCall_jidi"] = function () {
    return (dynCall_jidi = Module["dynCall_jidi"] = Module["asm"]["ll"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iidi = (Module["dynCall_iidi"] = function () {
    return (dynCall_iidi = Module["dynCall_iidi"] = Module["asm"]["nl"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_dddi = (Module["dynCall_dddi"] = function () {
    return (dynCall_dddi = Module["dynCall_dddi"] = Module["asm"]["xl"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ddi = (Module["dynCall_ddi"] = function () {
    return (dynCall_ddi = Module["dynCall_ddi"] = Module["asm"]["yl"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ddii = (Module["dynCall_ddii"] = function () {
    return (dynCall_ddii = Module["dynCall_ddii"] = Module["asm"]["Al"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jdii = (Module["dynCall_jdii"] = function () {
    return (dynCall_jdii = Module["dynCall_jdii"] = Module["asm"]["Il"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vdii = (Module["dynCall_vdii"] = function () {
    return (dynCall_vdii = Module["dynCall_vdii"] = Module["asm"]["Ml"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_didi = (Module["dynCall_didi"] = function () {
    return (dynCall_didi = Module["dynCall_didi"] = Module["asm"]["Ql"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_di = (Module["dynCall_di"] = function () {
    return (dynCall_di = Module["dynCall_di"] = Module["asm"]["_l"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fff = (Module["dynCall_fff"] = function () {
    return (dynCall_fff = Module["dynCall_fff"] = Module["asm"]["lm"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ijj = (Module["dynCall_ijj"] = function () {
    return (dynCall_ijj = Module["dynCall_ijj"] = Module["asm"]["mm"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vjji = (Module["dynCall_vjji"] = function () {
    return (dynCall_vjji = Module["dynCall_vjji"] = Module["asm"]["nm"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ij = (Module["dynCall_ij"] = function () {
    return (dynCall_ij = Module["dynCall_ij"] = Module["asm"]["om"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vid = (Module["dynCall_vid"] = function () {
    return (dynCall_vid = Module["dynCall_vid"] = Module["asm"]["rm"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iiif = (Module["dynCall_iiif"] = function () {
    return (dynCall_iiif = Module["dynCall_iiif"] = Module["asm"]["vm"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fif = (Module["dynCall_fif"] = function () {
    return (dynCall_fif = Module["dynCall_fif"] = Module["asm"]["wm"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fiff = (Module["dynCall_fiff"] = function () {
    return (dynCall_fiff = Module["dynCall_fiff"] = Module["asm"]["Bm"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viff = (Module["dynCall_viff"] = function () {
    return (dynCall_viff = Module["dynCall_viff"] = Module["asm"]["Nm"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iif = (Module["dynCall_iif"] = function () {
    return (dynCall_iif = Module["dynCall_iif"] = Module["asm"]["Tm"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vij = (Module["dynCall_vij"] = function () {
    return (dynCall_vij = Module["dynCall_vij"] = Module["asm"]["bn"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vf = (Module["dynCall_vf"] = function () {
    return (dynCall_vf = Module["dynCall_vf"] = Module["asm"]["cn"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vff = (Module["dynCall_vff"] = function () {
    return (dynCall_vff = Module["dynCall_vff"] = Module["asm"]["en"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vfff = (Module["dynCall_vfff"] = function () {
    return (dynCall_vfff = Module["dynCall_vfff"] = Module["asm"]["fn"]).apply(
      null,
      arguments
    );
  });
  var dynCall_f = (Module["dynCall_f"] = function () {
    return (dynCall_f = Module["dynCall_f"] = Module["asm"]["gn"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ff = (Module["dynCall_ff"] = function () {
    return (dynCall_ff = Module["dynCall_ff"] = Module["asm"]["jn"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fiif = (Module["dynCall_fiif"] = function () {
    return (dynCall_fiif = Module["dynCall_fiif"] = Module["asm"]["kn"]).apply(
      null,
      arguments
    );
  });
